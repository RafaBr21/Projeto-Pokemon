...
import BannerComplete from '../../assets/banner.png'
        ...
        <section className={styles.Section_Home}>
            ...
            <article className={styles.article_Content}>
                ...
                <h2 className={styles.title_two}>
                    You can know the type of Pokemon, its strengths, disadvantages and abilities</h2>
                <button className={styles.button}>See pokemons</button>
            </article>
            <img className={styles.img} src={BannerComplete} alt="Imagem Completa do personagem Pikachu" />
        </section>
    )
}